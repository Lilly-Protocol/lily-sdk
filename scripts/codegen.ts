...
function main() {
  ...
  if (!existsSync(specPath)) {
    ...
    console.error(
      'Provide a spec path as argument or place it at openapi/lily-backend.yaml',
    );
    process.exit(1);
  }
  ...
  try {
    ...
    console.error(
      'openapi-typescript failed. Ensure it is installed: npm install -D openapi-typescript',
    );
    process.exit(1);
  }
